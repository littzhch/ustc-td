...
const WAVE_TABLE = [
  ...
  [...repeat("homework", 6), ...repeat("ddl", 3), ...repeat("report", 2), ...repeat("ppt", 1), ...repeat("bug", 1)],
  [...repeat("homework", 4), ...repeat("ddl", 4), ...repeat("report", 2), ...repeat("ppt", 3), ...repeat("bug", 2)],
  [...repeat("homework", 3), ...repeat("ddl", 5), ...repeat("report", 3), ...repeat("ppt", 3), ...repeat("bug", 3)],
  [...repeat("homework", 4), ...repeat("ddl", 4), ...repeat("report", 4), ...repeat("ppt", 4), ...repeat("bug", 4)],
  [...repeat("homework", 6), ...repeat("ddl", 5), ...repeat("report", 5), ...repeat("ppt", 4), ...repeat("bug", 5)],
];
